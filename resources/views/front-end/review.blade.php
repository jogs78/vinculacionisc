			   			...
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">Empresas</h1>
									<h2>Te vinculamos al sector laboral!!!</h2>
	...
	<div id="fh5co-about">
		<div class="container">
			<div class="col-md-6 animate-box">
				...
				<p>Ser un enlace entre nuestros alumnos, egresados y los empleadores.</p>
			</div>
			<div class="col-md-6">
			...
			<div class="row">
				<!--<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							<h3><a href="#">Beneficios a los empleadores</a></h3>
				...
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							...
							<p>Nuestros alumnos obtienen solicitudes de Residencia Profesional por parte de diferentes organizacion vinculandolos asi con el sector 
							laboral.</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							<h3><a href="#">Beneficio a los universitarios</a></h3>
