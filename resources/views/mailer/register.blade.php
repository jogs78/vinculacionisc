...
<head>
	...
	<title>Bienvenido | VINCULACIÓN</title>
					...
					<table cellspacing="0" cellpadding="0" width="600" class="w320">
											...
											<table cellspacing="0" cellpadding="0" width="100%">
												...
												<tr>
													<td style="font-size:24px; text-align:center; padding: 0 75px; color:#6f6f6f;" class="w320 mobile-spacing; ">
														Tu cuenta esta lista para usar.
													</td>
												</tr>
											</table>
												...
												<table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
													<tr>
														<td style="text-align:left; color: #6f6f6f;">
															<br>
															Hola {{ $datamail['name'] }},<br><br>
															Tu cuenta ha sido creada exitosamente, a continuación te presentamos el e-mail con el cual se dio de alta, te invitamos a restablecer tu contraseña para hacer de ella uso personal.<br><br>
															Usuario:{{ $datamail['email'] }} <br>
															Gracias por tu registro!<br>
															VINCULACIÓN <br>
														</tr>
													</table>
												</center>
                      ...
                      <div><!--[if mso]>
                        <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:45px;v-text-anchor:middle;width:220px;" stroke="f" fillcolor="#f5774e">
                          ...
                          <center>
                          	<![endif]-->
                          	<a href="http://vinculacion.isc.ittg.mx/"
                          	style="background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:220px;-webkit-text-size-adjust:none;">Comienza hoy!</a>
                            <!--[if mso]>
                          </center>
                        </v:rect>
                        <![endif]--></div>
            ...
            <table cellspacing="0" cellpadding="0" bgcolor="#363636"  class="force-full-width">
            	...
            	<tr>
            		<td style="color:#27aa90; font-size: 14px; text-align:center;">
            			<a href="#">Ver en navegador</a> | <a href="#">Contacto</a> | <a href="#">Citas</a>
            		</td>
            	</tr>
            	<tr>
