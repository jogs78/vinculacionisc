...
<div id="formulario">
  {!! Form::model($poll,['route'=>['upscompany2.update',$poll->id_poll],'method'=>'patch'])!!}
...
<h3 id="p1">2.- El tamaño de su empresa es u organismo </h3>
        <input  type="radio" name="p2" value="Microempresa" id="p1" checked/> Microempresa (De 1 a 30) <br />
        <input  type="radio" name="p2" value="Pequeña" id="p1"/> Pequeña (De 31 a 100) <br />
        <input  type="radio" name="p2" value="Mediana" id="p1"/> Mediana (de 101 a 500)<br />
        <input  type="radio" name="p2" value="Grande" id="p1"/> Grande (Más de 500)<br />
<hr >
